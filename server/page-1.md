...
> **근거 문서**: 01-app-routing-and-global-drawers.md\
> **작성 기준**: 실제 코드 (`src/main.jsx`, `App.jsx`, `AuthContext.jsx` 등)\
> **관련 기능명세**: 08-앱-진입-및-화면-전환.md
...
SWR 키 정본: 17-common-data-structures-and-api.md
...
| 문서                                    | 내용                   |
| ------------------------------------- | -------------------- |
| 01-app-routing-and-global-drawers.md  | 핵심 파일·부트스트랩·드로어 키 요약 |
| 17-common-data-structures-and-api.md  | SWR 키 정본, 위젯 JSON 구조 |
| 08-chart-detail-drawer-normal-flow.md | Bento 일반 상세 흐름       |
| 09-chart-detail-drawer-fft-flow.md    | Bento FFT 상세 흐름      |
| 19-widget-detail-drawer-flow.md       | 위젯 그리드 상세 흐름         |
| 08-앱-진입-및-화면-전환.md                    | 사용자 관점 기능 명세         |
