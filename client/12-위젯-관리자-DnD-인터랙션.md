...
### 1.2 MIME 타입 (widgetManagerUtils)

센서 DnD / CCTV DnD / 좌측 순서 DnD MIME 분리 → 잘못된 그룹 drop 방지
...
| `widgetManagerUtils.js` | `normalizeSensorType`, MIME 상수 |
...
| 문서 | 내용 |
|------|------|
| [11-위젯-관리자-그룹-CRUD.md](./11-위젯-관리자-그룹-CRUD.md) | CRUD |
