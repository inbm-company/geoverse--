...
* 같은 상태 키를 구독하므로, 대시보드 진입 시 두 인스턴스가 동시에 `open={true}`가 될 수 있다.
...
| `src/pages/dashboard/widget-grid-layout/detail/widgetDetailDrawerUtils.js` | 위젯 상세 상태 제어              | `openWidgetDetailDrawer`, `closeWidgetDetailDrawer`, `isWidgetDetailDrawerTarget` |
