...
(siteConfig `useFft`와 상세 드로어 FFT_SENSOR_TYPES 목록을 함께 확인)
...
| 컴포넌트 | 설명 |
|----------|------|
| `ChartDetailDrawer` | Bento FFT 상세 |
...
| 문서 | 내용 |
|------|------|
| [08-차트-상세-드로어-일반.md](./08-차트-상세-드로어-일반.md) | 일반 상세 |
| [19-위젯-그리드-상세-드로어.md](./19-위젯-그리드-상세-드로어.md) | 위젯 FFT |
